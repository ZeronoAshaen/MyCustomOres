...
public class SpecialDustTexture extends TextureAtlasSprite
{
	private ItemSpecialDust itemDust;
	
	public SpecialDustTexture(ItemSpecialDust itemDust)
	{
	...
	public boolean load(IResourceManager manager, ResourceLocation location)
	{
		...
		try
		{
			IResource iResourceAlpha = manager.getResource(ResourceLocationHelper.getResourceLocation("textures/items/dust.png"));
			IResource iResourceShape = manager.getResource(ResourceLocationHelper.getResourceLocation("textures/items/dustShape.png"));
